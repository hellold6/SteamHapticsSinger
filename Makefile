...
steam-haptics-singer: main.cpp midifile/midifile.c
	$(CC) -c -o midifile.o midifile/midifile.c
	$(CXX) -o steam-haptics-singer main.cpp midifile.o `$(PKG_CONFIG) --libs --cflags $(LINUX_PACKAGES)`

steam-haptics-singer.exe: main.cpp midifile/midifile.c
	$(CC) -c -o midifile.o midifile/midifile.c
	$(CXX) -o steam-haptics-singer.exe main.cpp midifile.o `$(PKG_CONFIG) --libs --cflags $(WINDOWS_PACKAGES)`
